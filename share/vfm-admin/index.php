    ...
    print $encodeExplorer->getString("prettylinks"); ?> 
            ...
            <div class="row toggled">
                <div class="form-group col-xs-12">
                    <strong><?php print $encodeExplorer->getString("prettylink_old"); ?></strong>:<br><code>/vfm-admin/vfm-downloader.php?q=xxx</code><br>
    ...
    */ ?>
    ...
    <footer class="footer">
        ...
        <span class="pull-right">
            <a title="Veno File Manager" 
            target="_blank" href="http://filemanager.veno.it/">
                <i class="vfmi vfmi-typo"></i></a> <span class="badge small"><?php echo $vfm_version; ?></span>
        </span>
    </footer>
</div><!-- .wrapper -->
