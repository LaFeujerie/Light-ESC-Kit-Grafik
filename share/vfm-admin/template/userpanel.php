<?php
/**
 * VFM - veno file manager: template/userpanel.php
 * user menu, user panel and language selector (custom version)
 *
 * PHP version >= 5.3
 *
 * @category  PHP
...
if ($gateKeeper->isUserLoggedIn()) {
    ...
    if ($setUp->getConfig("show_usermenu") == true ) { 
        ...
        if ($gateKeeper->isSuperAdmin()) {
            echo " <li><a class=\"pull-right btn btn-default btn-sm\" href=\"vfm-admin/\"><i class=\"fa fa-cogs\"></i> 
            <span class=\"hidden-sm\">"
            .$encodeExplorer->getString("administration")."</span></a></li>";
        }
    }
